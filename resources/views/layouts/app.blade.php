...
<head>
    ...
    <!-- Title -->
    <title>{{ config('app.name', 'gsiproject') }}</title>

    <!-- Meta Tags -->
    <meta name="author" content="ColorlibHQ" />
    <meta name="description" content="AdminLTE is a Free Bootstrap 5 Admin Dashboard, 30 example pages using Vanilla JS." />
    <meta name="keywords" content="bootstrap 5, admin dashboard, laravel, adminlte, colorlibhq" />
    ...
    <!-- OverlayScrollbars -->
    <link href="https://cdn.jsdelivr.net/npm/overlayscrollbars@2.10.1/styles/overlayscrollbars.min.css" rel="stylesheet" integrity="sha256-tZHrRjVqNSRyWg2wbppGnT833E/Ys0DHWGwT04GiqQg=" crossorigin="anonymous" />

    <!-- ApexCharts -->
    <link href="https://cdn.jsdelivr.net/npm/apexcharts@3.37.1/dist/apexcharts.css" rel="stylesheet" integrity="sha256-4MX+61mt9NVvvuPjUWdUdyfZfxSB1/Rf9WtqRHgG5S0=" crossorigin="anonymous" />
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('adminlte/pages/generate/theme.html') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/widgets/info-box.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>info Box</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/widgets/cards.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Cards</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/layout/unfixed-sidebar.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Default Sidebar</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/layout/layout-custom-area.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Layout <small>+ Custom Area </small></p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/layout/sidebar-mini.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Sidebar Mini</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/layout/logo-switch.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Sidebar Mini <small>+ Logo Switch</small></p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/layout/layout-rtl.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Layout RTL</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('adminlte/pages/docs/introduction.html') }}" class="nav-link">
                                <i class="nav-icon bi bi-download"></i>
                                <p>Installation</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ asset('adminlte/pages/docs/layout.html') }}" class="nav-link">
                                <i class="nav-icon bi bi-grip-horizontal"></i>
                                <p>Layout</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ asset('adminlte/pages/docs/color-mode.html') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/docs/components/main-header.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Main Header</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/docs/components/main-sidebar.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Main Sidebar</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ asset('adminlte/pages/docs/javascript/treeview.html') }}" class="nav-link">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Treeview</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('adminlte/pages/docs/browser-support.html') }}" class="nav-link">
                                <i class="nav-icon bi bi-browser-edge"></i>
                                <p>Browser Support</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ asset('adminlte/pages/docs/how-to-contribute.html') }}" class="nav-link">
                                <i class="nav-icon bi bi-hand-thumbs-up-fill"></i>
                                <p>How To Contribute</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ asset('adminlte/pages/docs/faq.html') }}" class="nav-link">
                                <i class="nav-icon bi bi-question-circle-fill"></i>
                                <p>FAQ</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ asset('adminlte/pages/docs/license.html') }}" class="nav-link">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="row text-center m-1">
                                                ...
                                                <div class="col-3 p-2">
                                                    <img
                                                        class="img-fluid rounded-circle"
                                                        src="{{ asset('adminlte/assets/img/user4-128x128.jpg') }}"
                                                        alt="User Image" />
                                                    <a
                                                        class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                        href="#">
                                        ...
                                        <table class="table m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a
                                                            href="{{ asset('adminlte/pages/examples/invoice.html') }}"
                                ...
                                <div class="card-body p-0">
                                    <div class="px-2">
                                        <div class="d-flex border-top py-2 px-1">
                                            <div class="col-2">
                                                <img
                                                    src="{{ asset('adminlte/assets/img/default-150x150.png') }}"
                                                    alt="Product Image"
                                                    class="img-size-50" />
                                            </div>
                                            <div class="col-10">
